...
export const StudentDashboard: React.FC = () => {
  ...
  return (
    <div class="space-y-6">
      <div>
        <h1 class="text-2xl font-bold">Student Workspace</h1>
        <p class="text-slate-500 text-sm">Track your reading metrics, active borrowings, and study milestones</p>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card class="p-6 lg:col-span-2">
          <h3 class="text-sm font-semibold mb-4 text-slate-500 uppercase">Weekly Activity Tracking</h3>
        ...
        <Card class="p-6 lg:col-span-1 flex flex-col justify-between">
          <div>
            <h3 class="text-sm font-semibold mb-4 text-slate-500 uppercase">Upcoming Deadlines</h3>
            <div class="space-y-4">
              <div class="flex items-start space-x-3 p-3 rounded-xl bg-red-50/50 dark:bg-red-950/10 border border-red-100/50 dark:border-red-900/10 text-xs">
                <div class="font-bold text-red-600">Due 10 Jul</div>
                <div>
                  <h4 class="font-medium text-slate-800 dark:text-slate-200">Introduction to Algorithms</h4>
                  <p class="text-slate-500">ISBN: 978-0262033848</p>
                </div>
              </div>
              <div class="flex items-start space-x-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-800/40 text-xs">
                <div class="font-bold text-slate-500">Due 24 Jul</div>
                <div>
                  <h4 class="font-medium text-slate-800 dark:text-slate-200">Linear Algebra and Its Applications</h4>
                  <p class="text-slate-500">ISBN: 978-0321385178</p>
                </div>
              </div>
            </div>
          </div>
          <button class="mt-4 w-full bg-primary-50 hover:bg-primary-100 dark:bg-primary-950/20 dark:hover:bg-primary-950/40 text-primary-600 dark:text-primary-400 py-2 rounded-xl text-xs font-semibold transition-all">
