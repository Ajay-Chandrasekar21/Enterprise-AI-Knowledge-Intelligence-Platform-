...
export const LibrarianDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">Librarian Operations Console</h1>
        <p className="text-slate-500 text-sm">Monitor catalog acquisitions, processing pipelines, and checkouts</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="p-6 lg:col-span-1">
          <h3 className="text-sm font-semibold mb-4 text-slate-500 uppercase">Document Ingestion Share</h3>
        ...
        <Card className="p-6 lg:col-span-2">
          <h3 className="text-sm font-semibold mb-4 text-slate-500 uppercase">Catalog Scaling Trajectory</h3>
          <div className="h-64 flex items-center justify-center">
