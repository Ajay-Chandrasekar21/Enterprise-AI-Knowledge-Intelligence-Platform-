    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50 dark:bg-slate-950">
      <Card className="w-full max-w-lg p-8 glass-card">
        ...
        <div className="flex flex-col items-center space-y-2 mb-8 text-center">
          ...
          <p className="text-slate-500 text-xs">Create your portal login and profile mappings</p>
        </div>
        ...
        <div className="mt-6 text-center text-xs font-medium text-slate-500">
          ...
          <Link to="/login" className="text-primary-600 dark:text-primary-400 hover:underline">Log in</Link>
        </div>
